...
if [ "$OPERATION" == "deploy" ]; then
    ...
    gcloud dataflow flex-template run "differ-job" \
        ...
        --parameters currentData="gs://datcom-prod-imports/scripts/entities/Place/2026-02-24/**/*.mcf*" \
        --parameters previousData="gs://datcom-prod-imports/scripts/entities/Place/2026-02-15/**/*.mcf*" \
        --parameters outputLocation="gs://datcom-dataflow/differ/place" \
