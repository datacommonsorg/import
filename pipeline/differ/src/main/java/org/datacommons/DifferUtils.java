...
public class DifferUtils {
  ...
  /**
   * Converts an MCF graph to a PCollection of Key-Val pairs where key contains PVs excluding value.
   *
                  ...
                  public void process(ProcessContext c) {
                    try {
                      ...
                      for (PropertyValues pvs : g.getNodesMap().values()) {
                        if (GraphUtils.GetPropertyValue(
                                pvs.getPvsMap(), Property.typeOf.name())
