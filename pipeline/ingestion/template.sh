...
if [ "$OPERATION" == "deploy" ]; then
    ...
    gcloud dataflow flex-template run "ingestion-job" \
        ...
        --parameters ^~^importList='[{"importName":"USFed_ConstantMaturityRates","latestVersion":"gs://datcom-prod-imports/scripts/us_fed/treasury_constant_maturity_rates/USFed_ConstantMaturityRates/2026_01_06T19_18_04_771937_08_00", "graphPath":"/*/*/*.mcf"}]' \
