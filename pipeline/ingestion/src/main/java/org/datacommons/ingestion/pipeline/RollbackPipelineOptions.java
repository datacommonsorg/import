...
/** RollbackPipelineOptions interface for defining Spanner time-travel rollback options. */
public interface RollbackPipelineOptions extends SpannerPipelineOptions {
