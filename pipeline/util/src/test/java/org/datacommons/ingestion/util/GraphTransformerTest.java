                ...
                PropertyValues.newBuilder()
                    .putPvs(
                        ...
                        Values.newBuilder()
                            .addTypedValues(
                                TypedValue.newBuilder()
                                    .setValue("dcid:latLong/3315750_-11604133")
                                    .setType(ValueType.RESOLVED_REF))
                            .build())
                    .build())
            .build();
                ...
                PropertyValues.newBuilder()
                    ...
                    .putPvs(
                        ...
                        Values.newBuilder()
                            .addTypedValues(
                                TypedValue.newBuilder()
                                    .setValue("dcid:latLong/1000000_2000000")
                                    .setType(ValueType.RESOLVED_REF))
                            .build())
                    .build())
            .putNodes(
                ...
                PropertyValues.newBuilder()
                    .putPvs(
                        ...
                        Values.newBuilder()
                            .addTypedValues(
                                TypedValue.newBuilder()
                                    .setValue("dcid:DegreeCelsius-5.5")
                                    .setType(ValueType.RESOLVED_REF))
                            .build())
                    .build())
            .putNodes(
