...
class StatVarGroupGeneratorIntegrationTest(AggregationIntegrationTestBase):
    ...
    def test_stat_var_group_generation(self):
        ...
        with self.database.snapshot(multi_use=True) as snapshot:
            ...
            self.assertNotIn(('Median_Age_Student', 'linkedMemberOf', f'{ns}g/TestCustomVertical', prov_custom), edges)
            self.assertNotIn(('Median_Age_Student', 'linkedMemberOf', f'{ns}g/Root', prov_custom), edges)
    ...
    def test_stat_var_group_generation_only_custom_import(self):
        ...
        with self.database.snapshot(multi_use=True) as snapshot:
            ...
            self.assertNotIn(('Count_Student', 'memberOf', f'{ns}g/Student', prov_test), edges)
            self.assertNotIn(('Count_Student', 'linkedMemberOf', f'{ns}g/Student', prov_test), edges)
            self.assertNotIn(('Count_Student_Female', 'memberOf', f'{ns}g/Student_Gender-Female', prov_test), edges)
            self.assertNotIn(('Count_Person', 'memberOf', f'{ns}g/TestVertical', prov_test), edges)
            self.assertNotIn(('Count_Thing', 'memberOf', f'{ns}g/Uncategorized_Variables', prov_test), edges)
