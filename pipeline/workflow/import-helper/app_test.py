...
class AppTest(unittest.TestCase):
    ...
    def test_invoke_import_automation_airflow_generic_and_fallback(self, mock_auth, mock_post, mock_fetch_id_token):
        ...
        self.assertEqual(called_url, "https://airflow.example.com/api/v1/dags/import_automation_workflow/dagRuns")
        ...
        self.assertEqual(fallback_url, "https://airflow.example.com/api/v1/dags/import_automation_workflow/dagRuns")
