...
/**
 * stateOrder is a helper function which returns the column index of the
 * detected state column based on a ranked order of preferred property types.
 * For example, given two columns both of which represent states, if one of
 * them has ISO codes and the other state names, we will prefer the one with
 * ISO codes.
 *
 ...
 *    4. State name.
 *
 * @param detectedStates is a mapping from column indices to the DetectedDetails
...
//  */
// function stateOrder(detectedStates: Map<number, DetectedDetails>): number {
//   const propOrder = [
//     "isoCode",
//     "fips52AlphaCode",
//     "name",
