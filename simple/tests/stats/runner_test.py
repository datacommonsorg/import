...
class TestRunner(unittest.TestCase):
  ...
  def test_dcp_bridge_header_validation_failure_handshake(self):
    ...
    with mock.patch("stats.runner.create_store", side_effect=side_effect) as mock_create_store:
      with tempfile.TemporaryDirectory() as temp_dir:
        ...
        mock_create_store.assert_called_with(expected_handshake_path, create_if_missing=True, treat_as_file=True)
        ...
        self.assertEqual(err["errorType"], "CSV_HEADER_VALIDATION")
