...
class TestFileMatch(unittest.TestCase):
  ...
  def test_pipe_matching(self):
    store = create_store("temp://")

    # Test filename matching with alternation
    ...
    # Test directory matching with alternation (standard brace expansion and grouping)
    ...
    # Test mixed path-depth top-level alternation (e.g. root CSV or nested MCF)
