...
public class PropertyResolverTest {
  ...
  private static final String CN_DCID = "country/CHN";
  ...
  private static final PropertyValues CN = newNode("Place", Map.of("isoCode", "CN"));
  ...
  public void endToEnd() {
    ...
    // Test manual resolution before drain
    resolver.addResolvedId("isoCode", "CN", CN_DCID);
    ...
    assertThat(resolver.resolve("cn", CN).get()).isEqualTo(CN_DCID);
